...
module Decorator =
    ...
    let private foregroundColorCode (color: ConsoleColor): int =
        match color with
    ...
    let private backgroundColorCode (color: ConsoleColor): int =
        match color with
    ...
    let foregroundColor (color: ConsoleColor) (message: string): string =
    ...
    /// <param name="message">The message to be styled.</param>
    let foregroundColorRGB (redValue: int, greenValue: int, blueValue: int) (message: string): string =
    ...
    /// <param name="message">The message to be styled.</param>
    let backgroundColor (color: ConsoleColor) (message: string): string =
    ...
    /// <param name="blueValue">The blue component of the RGB color (0-255).</param>
    /// <param name="message">The message to be styled.</param>
    let backgroundColorRGB (redValue: int, greenValue: int, blueValue: int) (message: string): string =
    ...
    /// <param name="message">The message to be styled.</param>
    let foreAndBackgroundColor (foregroundColor: ConsoleColor) (backgroundColor: ConsoleColor) (message: string): string =
    ...
    /// <param name="message">The message to be styled.</param>
    let bold (message: string): string =
        $"\u001b[1m%s{message}\u001b[0m"


    /// <summary>Makes the given message italicized.</summary>
    /// <param name="message">The message to be styled.</param>
    let italic (message: string): string =
        $"\u001b[3m%s{message}\u001b[0m"


    /// <summary>Underlines the given message.</summary>
    /// <param name="message">The message to be styled.</param>
    let underline (message: string): string =
        $"\u001b[4m%s{message}\u001b[0m"
    ...
    let getNumberEmoji (number: int): string =
    ...
    let getOrdinalIndicator (number: int): string =
        let suffix: string =
